...
import transformEscapeCompat from './transformEscapeCompat';
import { uniqID } from '../../../helpers/string';
import { protonizer as purifyHTML } from '../../../helpers/purify';
...
export default (content, { action, cache, activeCache = true } = {}) => {
    // We use the old processing code as both don't support the sandbox from DOMPurify and will leak
    if (isIE11()) {
        return transformEscapeCompat(content, { action, cache, activeCache });
    }
